...
public class SHFAState {
    ...
    public static LinkedHashSet<String> enabledBlocksDefault = new LinkedHashSet<>(List.of("#minecraft:fences",
            "#minecraft:wool_carpets", "#shfa:glass_panes", "#shfa:torches", "minecraft:chain", "minecraft:iron_bars",
            "minecraft:end_rod", "minecraft:lantern", "minecraft:soul_lantern"));
    ...
    public static boolean showHitbox(BlockState state) {
        ...
        // Debug logging removed (reverting previous change)
